...
folkol@ubuntu:~/code/labs/1brc/java-orig$ taskset -c 0-7 hyperfine --warmup 5 --runs 20 target/CalculateAverage_thomaswue_image ../onebrc/target-pgo-use/release/thomaswue_ported 
Benchmark 1: target/CalculateAverage_thomaswue_image
...
folkol@ubuntu:~/code/labs/1brc/java-orig$ hyperfine --warmup 10 --runs 40 target/CalculateAverage_thomaswue_image ../onebrc/target-pgo-use/release/thomaswue_ported 
Benchmark 1: target/CalculateAverage_thomaswue_image
